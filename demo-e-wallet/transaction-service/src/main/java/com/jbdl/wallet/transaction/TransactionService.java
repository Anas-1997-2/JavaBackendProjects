...
public class TransactionService {
	 private static final String TXN_CREATE_TOPIC = "txn_create";
	    ...
	    @KafkaListener(topics = {WALLET_UPDATE_TOPIC}, groupId = "consumer1_group")
	    public void updateTxn(String msg) throws Exception{
	        ...
	        JSONObject sender = restTemplate.getForObject("http://localhost:9000/user/id?id=" + senderId, JSONObject.class);
	        String senderEmail = (String) sender.get("email");

	        JSONObject receiver = restTemplate.getForObject("http://localhost:9000/user/id?id=" + receiverId, JSONObject.class);
